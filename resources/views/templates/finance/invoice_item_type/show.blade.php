            ...
            <div class="card border-light shadow-sm components-section">
                <div class="card-body">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <x-form.show name="name" :label="__('Leistungstyp')"  :value="$invoiceItemType->name" :labelClass="'col-sm-3'"   />
                        <x-form.show name="comment" :label="__('Kommentar')" :value="$invoiceItemType->comment" :labelClass="'col-sm-3'"   />

                        <a href="{{ route('finance.invoiceItemTypes.index') }}" class="btn btn-primary">{{ __('Zurück zur Übersicht') }}</a>
                    </div>
                </div>
            </div>
        </div>
