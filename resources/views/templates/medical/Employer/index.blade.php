...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            <x-template.breadcrumb :activePage="__('Tätigkeit')" :links="[['key' => config('constants.APPLICATIONS.MEDICAL.TITLE'), 'url' => url('medical')]]" />
            <h2 class="h4">{{ __('Tätigkeit') }}</h2>
            <p class="mb-0"></p>
        </div>
    ...
    <div class="card card-body shadow-sm table-wrapper table-responsive table-power-grid">
        <livewire:medical.activity-table />
    </div>
