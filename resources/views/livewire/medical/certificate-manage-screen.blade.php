<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            <x-template.breadcrumb :activePage="__('Bescheinigung ändern')" :links="[
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group ms-2 ms-lg-3">
                ...
                @endif
                <a wire:click="submit" class="btn btn-sm btn-outline-primary"><i class="fas fa-save"></i> {{ __('Speichern') }}</a>
            </div>
        </div>
    ...
    <form wire:submit="submit">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="float-end">
                                    ...
                                    {{ __('Bescheinigung Nr.') }}: {{ $certificate->certificate_number }}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body collapse show pb-0 pt-0" id="collapseOrder">
        ...
        <div class="row">
            <div class="col-12 mb-4">
                <div class="card border-light shadow-sm components-section">
                    <div class="card-header collapsed" data-bs-toggle="collapse" href="#collapseEmployer" role="button" aria-expanded="false" aria-controls="collapseEmployer">
                        {{ __('Arbeitgeber') }}
                        @if($employerWithErrors)
                            <i class="fas fa-exclamation-circle text-danger ms-3"></i>
                        @endif
                    </div>
                    <div class="card-body collapse pb-0 pt-0" id="collapseEmployer" wire:ignore.self>
                        <div class="row pt-4 pb-4">
                            <div class="col-sm-8">
                                <div>
        ...
        <div id="preventions" class="card">
            ...
            <div class="card-body">
                ...
                <div class="accordion" id="preventionItemAccordion">
                    @foreach($inputs as $inputId => $input)
                        <div class="accordion-item" id="accordion-parent-{{ $loop->iteration }}">
                            <h2 class="accordion-header" id="panelsStayOpen-heading{{ $inputId }}">
                                <div class="accordion-button @if($inputs[$inputId]['id']) accordion-button-with-icons @endif collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse{{ $inputId }}" aria-expanded="false" aria-controls="panelsStayOpen-collapse{{ $inputId }}">
                            ...
                            <div id="panelsStayOpen-collapse{{ $inputId }}" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-heading{{ $inputId }}" data-bs-parent="#preventionItemAccordion" wire:ignore.self>
