...
class InvoiceItemPolicy
{
    ...
    {
        return $user->can(config('perm.finance.invoiceItem.view'));
    }
    ...
    {
        return $user->can(config('perm.finance.invoiceItem.create'));
    }
    ...
    {
        return $user->can(config('perm.finance.invoiceItem.update'));
    }
    ...
    {
        return $user->can(config('perm.finance.invoiceItem.delete'));
    }
